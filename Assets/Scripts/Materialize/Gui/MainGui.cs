...
namespace Materialize.Gui
{
    public class MainGui : MonoBehaviour, IHideGuiManager
    {
        ...
        public ProgramEnums.PropChannelMap PropBlue = ProgramEnums.PropChannelMap.None;

        public ProgramEnums.PropChannelMap PropGreen = ProgramEnums.PropChannelMap.None;

        public ProgramEnums.PropChannelMap PropRed = ProgramEnums.PropChannelMap.None;
        ...
        private static string PCM2String(ProgramEnums.PropChannelMap pcm, string defaultName)
        {
            var returnString = defaultName;

            switch (pcm)
            {
                case ProgramEnums.PropChannelMap.Height:
                    returnString = "Height";
                    break;
                case ProgramEnums.PropChannelMap.Metallic:
                    returnString = "Metallic";
                    break;
                case ProgramEnums.PropChannelMap.Smoothness:
                    returnString = "Smoothness";
                    break;
                case ProgramEnums.PropChannelMap.MaskMap:
                    returnString = "MaskMap";
                    break;
                case ProgramEnums.PropChannelMap.Ao:
                    returnString = "Ambient Occ";
                    break;
                case ProgramEnums.PropChannelMap.None:
                    break;
                default:
        ...
        private void SetPropertyMapChannel(string texPrefix, ProgramEnums.PropChannelMap pcm)
        {
            switch (pcm)
            {
                case ProgramEnums.PropChannelMap.Height:
        ...
        public CountLocker HideGuiLocker { get; set; } = new CountLocker();
