...
public class MaterialGui : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Mathf.Abs(_thisMaterial.GetFloat(DisplacementOffsetId) - _dispOffset) > 0.01f)
        {
    ...
    private void ChooseLightColor(int posX, int posY)
    {
        ...
        _materialSettings.LightIntensity =
            GUI.VerticalSlider(new Rect(posX + 120, posY + 5, 30, 100), _materialSettings.LightIntensity, 30.0f, 0.0f);
    ...
    private void DoMyWindow(int windowId)
    {
        ...
        GuiHelper.Slider(new Rect(offsetX, offsetY, 280, 50), "Metallic Multiplier", _materialSettings.Metallic,
            out _materialSettings.Metallic, 0.0f, 1.0f);
        offsetY += 40;
        ...
        GuiHelper.Slider(new Rect(offsetX, offsetY, 280, 50), "Displacement Amplitude",
            _materialSettings.DisplacementAmplitude, out _materialSettings.DisplacementAmplitude, 0.0f, 100.0f);
        offsetY += 40;
