...
namespace SimpleLightProbePlacer
{
    ...
    public class LightProbeVolume : TransformVolume
    {
        ...
        public static List<Vector3> CreatePositionsFixed(Transform volumeTransform, Vector3 origin, Vector3 size,
            Vector3 density)
        {
        ...
        public static List<Vector3> CreatePositionsFloat(Transform volumeTransform, Vector3 origin, Vector3 size,
            Vector3 density)
        {
            var posList = new List<Vector3>();
            var offset = origin;
