namespace Crosstales.FB.Util
{
    ...
    public abstract class Constants : Common.Util.BaseConstants
    {
        ...
        public const string ASSET_VERSION = "2018.3.1";

        /// <summary>Build number of the asset.</summary>
        public const int ASSET_BUILD = 20181018;
        ...
        public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2018, 10, 18);
